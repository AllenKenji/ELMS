/**
 * Delete a committee meeting by id and committee id.
 * @param {string|number} committeeId
 * @param {string|number} meetingId
 * @returns {Promise<import('pg').QueryResult>}
 */
exports.deleteMeeting = async (committeeId, meetingId) => {
  return pool.query(
    'DELETE FROM committee_meetings WHERE id = $1 AND committee_id = $2 RETURNING *',
