...
router.get('/:id/sessions', workflowLimiter, authenticateToken, ordinanceController.getOrdinanceSessions);
...
router.post('/:id/admin/override-session', workflowLimiter, authenticateToken, authorizeRoles('Admin'), ordinanceController.adminOverrideSession);
router.post('/:id/admin/override-stage',   workflowLimiter, authenticateToken, authorizeRoles('Admin'), ordinanceController.adminOverrideStage);
