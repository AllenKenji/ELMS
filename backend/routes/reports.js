...
router.post('/', authenticateToken, authorizeRoles('Admin', 'Secretary', 'Councilor'), reportController.create);
...
router.put('/:id', authenticateToken, authorizeRoles('Admin', 'Secretary', 'Councilor'), reportController.update);
