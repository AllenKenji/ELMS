...
router.post('/', authenticateToken, authorizeRoles('Councilor', 'Admin', 'Secretary', 'Committee Secretary'), upload.array('attachments_files'), resolutionController.create);
...
router.post('/:id/admin/override-session', workflowLimiter, authenticateToken, authorizeRoles('Admin'), resolutionController.adminOverrideSession);
router.post('/:id/admin/override-stage',   workflowLimiter, authenticateToken, authorizeRoles('Admin'), resolutionController.adminOverrideStage);
...
router.post('/:id/record-second-session', workflowLimiter, authenticateToken, authorizeRoles('Secretary', 'Admin'), resolutionController.recordSecondSession);
