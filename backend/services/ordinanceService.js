...
exports.assignSessionForFirstReading = async (id, sessionId, userId, discussionNotes = '') => {
  ...
  try {
    ...
    await Ordinance.insertWorkflowAction(client, id, 'ASSIGN_SESSION', 'RECORD_SESSION', userId, workflowComment);
...
exports.conductFirstReading = async (id, sessionId, discussionNotes, presidingOfficer, userId, selectedRecordingUrl = null) => {
  ...
  try {
    ...
    await notifyUrgentActionByRoles(
      client,
      ['Vice Mayor'],
      `Urgent action: First reading conducted for ordinance "${ordinance.title}". Refer it to committee for the next stage.`,
      {
        type: 'warning',
        title: 'Urgent Action Required',
        relatedId: Number(id),
...
exports.assignSessionForSecondReading = async (id, sessionId, userId, discussionNotes = '') => {
  ...
  try {
    ...
    await Ordinance.insertWorkflowAction(client, id, 'ASSIGN_SECOND_SESSION', 'RECORD_SECOND_SESSION', userId, workflowComment);
