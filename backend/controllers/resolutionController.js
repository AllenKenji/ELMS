...
/** POST /resolutions/:id/admin/override-session */
exports.adminOverrideSession = async (req, res) => {
  try {
    const result = await resolutionService.adminOverrideSessionAssignment(
      req.params.id,
      req.body,
      req.user.id
    );
...
/** POST /resolutions/:id/admin/override-stage */
exports.adminOverrideStage = async (req, res) => {
  try {
    const result = await resolutionService.adminOverrideWorkflowStage(
      req.params.id,
      req.body,
      req.user.id
    );
