...
const READING_STAGE_COLORS = {
  ...
  'ASSIGN_SECOND_SESSION':      '#e67e22',
  'RECORD_SECOND_SESSION':      '#d35400',
...
const READING_STAGE_LABELS = {
  ...
  'ASSIGN_SECOND_SESSION':      'Assign 2nd Session',
  'RECORD_SECOND_SESSION':      'Record 2nd Session',
...
export default function OrdinanceDetails({ ordinanceId, onClose, onStatusChange, onUseAsPattern }) {
  ...
  const handleDeleteMeeting = async (meetingId) => {
    ...
    const endMeetingAttendeeCandidates = useMemo(() => {
      ...
      if (ordinance.committee.chair_id) {
        pushCandidate(ordinance.committee.chair_id, ordinance.committee.chair_name, 'Chair');
      }

      (ordinance.committee.members || []).forEach((member) => {
