...
import '../styles/ViceMayorDashboard.css';

export default function ViceMayorDashboard() {
  const { user } = useAuth();
  ...
  const getDashboardTitle = () => {
    ...
    return `${greeting}, ${user?.name || 'Vice Mayor'}!`;
  };

  return (
    <div className="dashboard-content vice-mayor-dashboard">
      {/* Header */}
      ...
      {/* Key Metrics */}
      <div className="dashboard-section">
        <h2 className="section-title">📊 Legislative Summary</h2>
      ...
      <div className="dashboard-section full-width">
        <TrendChart
          ...
          title="📈 Legislative Activity (Last 30 Days)"
        />
      </div>
    </div>
  );
